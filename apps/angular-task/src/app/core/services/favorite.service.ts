...
export class FavoriteService {
  ...
  private readonly STORAGE_KEY = 'FAVOURITE_USERS';
  ...
  constructor() {
    ...
    const storedFavorites = this.localStorageService.getItem<number[]>(this.STORAGE_KEY) || [];
    ...
    effect(() => {
      ...
      this.localStorageService.setItem(this.STORAGE_KEY, [...favorites]); // Sync to LocalStorage
    });
  }
